...
export function buildLocationInfo(location) {
    ...
    location.neighbourhood && locationInfo.add(location.neighbourhood);
    location.municipality && locationInfo.add(location.municipality);
    location.subregion && locationInfo.add(location.subregion);
