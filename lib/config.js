export const config = {
    ...
    MAP_DEFAULT_ZOOM_GEOLOCATION: 12,
    ...
    FETCH_URL: process.env.NODE_ENV === 'development' ? process.env.NEXT_PUBLIC_NUDEPLACES_BACKEND_URL_DEV : process.env.NEXT_PUBLIC_NUDEPLACES_BACKEND_URL,
    REVALIDATE_TIME_IN_SECONDS: 86400,
    SEO_NAME_GERMANY: 'germany',
    LANG_ENGLISH: 'en',
    LANG_GERMAN: 'de',
    WEBSITE_URL: 'https://www.nudeplaces.de',
}